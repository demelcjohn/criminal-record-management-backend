...
const update_police_user = async (req,res)=>
{
  try{
    ...
    const updateData = req.body;
        ...
        const result = await police.findOneAndUpdate({ _id: id }, updateData, { new: true, runValidators: true });
...
module.exports = { add_police_user, get_all_police_user,delete_police_user,update_police_user,get_indudaual_police_user };
